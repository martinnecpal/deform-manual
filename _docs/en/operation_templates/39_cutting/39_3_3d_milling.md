...
User can turn on tool wear calculation using “**Define model to calculate tool wea****r** ” check box. After turning on check box user can select the tool wear model and define its parameters as shown in the Fig. 39.3.22., for more information on these options please refer [20.4. Tool Wear](/docs/en/pre_processor/20_inter-object_data_definition/20_4_tool_wear/).
