---
lang: en
title: "Operation Templates MainPg"
---
...
[31\. Introduction to Extrusion](/docs/en/operation_templates/31_extrusion/31_introduction_to_extrusion/)

[31.1. 3D Extrusion](/docs/en/operation_templates/31_extrusion/31_1_3d_extrusion/)

**32\. Multi Blow Forging**
...
[33\. Introduction to Forming](/docs/en/operation_templates/33_forming/33_introduction_to_forming/)
...
[34 Introduction to Forming Express](/docs/en/operation_templates/34_forming_express/34_introduction_to_forming_express/)
...
[35\. Introduction to Heat Transfer Operations](/docs/en/operation_templates/35_heat_transfer/35_introduction_to_heat_transfer_operations/)

[35.1. 2D Heat Transfer Operation](/docs/en/operation_templates/35_heat_transfer/35_1_2d_heat_transfer_operation/)

[35.2. 3D Heat Transfer Operation](/docs/en/operation_templates/35_heat_transfer/35_2_3d_heat_transfer_operation/).

**3******6.** Heat Transfer Express**

[36\. Intorduction to Heat Transfer Express Operations](/docs/en/operation_templates/36_heat_transfer_express/36_introduction_to_heat_transfer_express_operations/)

[36.1. 2D Heat Transfer Express](/docs/en/operation_templates/36_heat_transfer_express/36_1_2d_heat_transfer_express/)

[36.2. 3D Heat Transfer Express](/docs/en/operation_templates/36_heat_transfer_express/36_2_3d_heat_transfer_express/)

**37\. Heat Treatment**

[37\. Introduction to Heat Treatment](/docs/en/operation_templates/37_heat_treatment/37_introduction_to_heat_treatment/)

[37.1. 2D Heat Treatment Wizard](/docs/en/operation_templates/37_heat_treatment/37_1_2d_heat_treatment_wizard/)

[37.2. 3D Heat Treatment Wizard](/docs/en/operation_templates/37_heat_treatment/37_2_3d_heat_treatment_wizard/)

**38\. Furnace Heating**

[38 Introduction to 3D HT Furnace](/docs/en/operation_templates/38_furnace_heating/38_introduction_to_3d_ht_furnace/)
...
**40\. Machining Distortion**

[40\. Introduction to Machining Distortion](/docs/en/operation_templates/40_machining_distortion/40_introduction_to_machining_distortion/)
...
[41\. Introduction to Report Generation](/docs/en/operation_templates/41_report_generation/41_introduction_to_report_generation/)

[41.1. Report Generation](/docs/en/operation_templates/41_report_generation/41_1_report_generation/)

**42\. Ring Rolling**

[42\. Introduction to Ring Rolling](/docs/en/operation_templates/42_ring_rolling/42_introduction_to_ring_rolling/)

[42.1. Ring Rolling](/docs/en/operation_templates/42_ring_rolling/42_1_ring_rolling/)

**43\. Shape Rolling**

[43\. Introduction to Shape Rolling](/docs/en/operation_templates/43_shape_rolling/43_introduction_to_shape_rolling/)

[43.1. Shape Rolling Manual](/docs/en/operation_templates/43_shape_rolling/43_1_shape_rolling_manual/)

**44\. 2D to 3D Converter**

[44\. Introduction to 2D to 3D Convertor](/docs/en/operation_templates/44_2d_to_3d_converter/44_introduction_to_2d_to_3d_converter/)

[44.1. 2D to 3D Converter](/docs/en/operation_templates/44_2d_to_3d_converter/44_1_2d_to_3d_converter/)

**45\. Boolean Operation**
...
[46\. Introduction to Copy/Mirroring](/docs/en/operation_templates/46_copy_mirroring/44_introduction_to_copy_mirroring/)

[46.1. Copy Mirroring](/docs/en/operation_templates/46_copy_mirroring/46_1_copy_mirroring/)

**47\. Add Cycle**

[47.Introdution to Add Cycle](/docs/en/operation_templates/47_add_cycle/47_introduction_to_add_cycle/)

**48\. Spinning**

[48 Introduction to Spinning](/docs/en/operation_templates/48_spinning/48_introduction_to_spinning/)
...
[50\. Introduction to 3D GEO TOOL](/docs/en/operation_templates/50_3d_geo_tool/50_introduction_to_3d_geo_tool/)
