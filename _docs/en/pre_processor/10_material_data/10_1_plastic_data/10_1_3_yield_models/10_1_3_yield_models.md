...
This functionality supports anisotropy. There are three different types of yield functions ([ANISO](/docs/en/keyword_documentation/a/aniso/)) available as shown in Fig. 10.1.3.1.
