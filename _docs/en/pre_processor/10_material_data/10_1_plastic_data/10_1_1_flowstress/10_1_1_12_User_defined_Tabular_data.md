---
lang: en
title: "10.1.1.12. User defined Tabular data"
---

# 10.1.1.12. User defined Tabular data

User can define the flowstress function as any combination of the available Input variables temperature, Stress, Strain, Time, Strain rate, Precipitate size, Precipitate shape and Precipitate Vol. fraction as shown in below Fig. 10.1.1.12.1.

  
![](../../../../../assets/Images/Pre-Processor/10_Material_Data/10_1_Plastic_Data/10_1_1_Flow_Stress/10_1_1_12_User_defined_Tabular_data/10_1_1_12_Image001.jpg)

Tabulate data flowstress model function definition window

  
User can see the graph by selecting graph view tab. Flowstress values are linearly interpolated in function variables space as shown in below Fig. 10.1.1.12.2.

  
![](../../../../../assets/Images/Pre-Processor/10_Material_Data/10_1_Plastic_Data/10_1_1_Flow_Stress/10_1_1_12_User_defined_Tabular_data/10_1_1_12_Image002.JPG)

Tabulate data flowstress graph view window
...
[10.1.1.11. Texture based flow stress model f(strn,strnrt,O,T)](/docs/en/pre_processor/10_material_data/10_1_plastic_data/10_1_1_flowstress/10_1_1_11_Texture_based_flow_stress_model_fstrnstrnrtOT/)  
