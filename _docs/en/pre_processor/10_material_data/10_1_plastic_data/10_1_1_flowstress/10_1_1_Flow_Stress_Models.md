---
lang: en
title: "10.1.1. Flow Stress Models"
---

# 10.1.1 Flow Stress Models

  
DEFORM provides different methods of defining the flow stress ([FSTRES](/docs/en/Keyword_Documentation/F/FSTRES/)) as shown in Fig. 10.1.1.1. Use the links below to know more about different types of flow stress models available in DEFORM.

![](../../../../../assets/Images/Pre-Processor/10_Material_Data/10_1_Plastic_Data/10_1_1_Flow_Stress/10_1_1_Image001.JPG)

Flow Stress Model option
...
[10.1.2. Creep data](/docs/en/pre_processor/10_material_data/10_1_plastic_data/10_1_2_Creep/10_1_2_Creep_Models/)  
[10.1.3. Yield model data](/docs/en/pre_processor/10_material_data/10_1_plastic_data/10_1_3_Yield_Models/10_1_3_Yield_Models/)  
10.1.4. Porous model data  
[10.1.5. Hardening rule data](/docs/en/pre_processor/10_material_data/10_1_plastic_data/10_1_5_Hardening_rule/10_1_5_Hardening_rule/)
