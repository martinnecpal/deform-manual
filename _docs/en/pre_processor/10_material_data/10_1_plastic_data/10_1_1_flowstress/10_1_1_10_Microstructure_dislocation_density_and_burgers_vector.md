---
lang: en
title: "10.1.1.10. Microstructure Flow stress model based on dislocation density and burgers vector"
---

# 10.1.1.10. Microstructure Flow stress model based on dislocation density and burgers vector

  
For this Flow stress see below Fig. 10.1.1.10.1.

  
![](../../../../../assets/Images/Pre-Processor/10_Material_Data/10_1_Plastic_Data/10_1_1_Flow_Stress/10_1_1_10_Microstructure_Flow_stress_model_/10_1_1_10_Image001.JPG)

Flow stress burgers vector model

  
Associated data need to define from the Grain tab is as shown in below Fig. 10.1.1.10.2.

![](../../../../../assets/Images/Pre-Processor/10_Material_Data/10_1_Plastic_Data/10_1_1_Flow_Stress/10_1_1_10_Microstructure_Flow_stress_model_/10_1_1_10_Image002.JPG)
