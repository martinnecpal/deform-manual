---
lang: en
title: "10.1.1.1. Tabular data format"
---

# 10.1.1.1. Tabular data format

The tabular format is the most versatile format in that it can represent any material where flow stress can be given as a function of strain, strain rate, and temperature.

![](../../../../../assets/Equations/Pre_Processor/10_Material_Data/10_1_Plastic_Data/10_1_1_FlowStress/EQ_10_1_1_1.JPG) |   
---|---  
  
**Interpolation methods:** There are two types of interpolation methods available for tabular data those are,

  * **Linear interpolation:** Flow stress values are interpolated linearly in strain, strain rate, and temperature space.
  * **Log interpolation:** Flow stress values are interpolated in log strain, log strain rate, and linear temperature space. For data points at 0.0 plastic strain, linear interpolation is used between the 0 value and the first non 0 value, and log interpolation is used for subsequent values.
