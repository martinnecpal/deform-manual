...
Please refer to [Chapter 56. User Routines](/docs/en/User_Routines/56_User_Routines_in_DEFORM/56_User_Routines_in_DEFORM/) for a description of how to implement user defined flow stress routines.
