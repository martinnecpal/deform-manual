...
Hyperelastic ([HYPREL](/docs/en/keyword_documentation/h/hyprel/)) is valid only for hyperelastic objects. From DEFORM v12, two hyperelastic constitutive models are provided to simulate hyperelasticity.  
...
[10.2. Elastic Data](/docs/en/pre_processor/10_material_data/10_2_elastic_data/10_2_elastic_data/)

[10.3 Thermal Data](/docs/en/pre_processor/10_material_data/10_3_thermal_data/10_3_thermal_data/)
