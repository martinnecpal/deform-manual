...
[11\. Object General Definition](/docs/en/pre_processor/11_general_object_data_definition/11_general_object_data_definition/)

[12\. Geometry Data](/docs/en/pre_processor/12_geometry_modelling/12_1_2d_geometry_data_defining/)
...
[15\. Movement Controls Definitions](/docs/en/pre_processor/15_movement_controls_definition/15_movement_controls_settings/)
...
[3D MO Basic Labs](/docs/en/labs/basic_labs/3d_labs/3d_labs/)

[Appendix XIV: Rotating Workpiece Simulations](/docs/en/appendices/appendix_xiv_rotating_workpiece_simulations/)

[Sheet Forming in DEFORM-3D](/docs/en/applications/55_applications/55_sheet_forming/sheet_forming_in_deform_3d/)
...
[Appendix XVI: Adding Gas Trap Calculation to a Simulation](/docs/en/appendices/appendix_xvi_adding_gas_trap_calculation_to_a_simulation/)

[Running creep simulations](/docs/en/applications/55_applications/55_creep/2d_creep/)

[Setting up induction heating in 2D](/docs/en/applications/55_applications/55_4_induction_heating/setting_up_induction_heating_in_deform/)

[Appendix III: Running DEFORM in text mode](/docs/en/appendices/appendix_iii_running_deform_in_text_mode/)
