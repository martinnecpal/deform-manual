---
lang: en
title: "51.2. 3D Inverse Heat Manual"
---

# 51.2. 3D Inverse Heat Manual

51.2.1. How to open 3D Inverse Heat wizard

51.2.2. Initialization

51.2.3. Process condition

51.2.4. Material List

51.2.5. Workpiece object page

51.2.5.1. Geometry page

51.2.5.2. Mesh page

51.2.5.3. Material Page

51.2.5.4. BCC Page

51.2.5.5. Property Page

51.2.6. Temperature Measurement Points

51.2.7. Time Zones

51.2.8. Heat Transfer Zones

51.2.9. Positioning

51.2.10. Step

51.2.11. Optimization Controls

51.2.12. Generate DB

51.2.13. Post-Processing the Inverse HT Optimized results

## How to open 3D Inverse Heat wizard

3D Inverse heat wizard can be accessed from GUI Main. Create a new problem by either selecting **File![]({{ '/assets/icons/pre_icons/arrow_front.jpg' | relative_url }}) ****New Problem** or by clicking the New Problem ![]({{ '/assets/icons/pre_icons/mo_new_problem_icon.jpg' | relative_url }}) icon. Select 3D Inverse heat Problem type and unit system as shown in the Fig. 51.2.1. then click ![]({{ '/assets/icons/pre_icons/mo_ok_button.jpg' | relative_url }}). 3D Inverse Heat Wizard will be opened and in Operation editor we can observe 3D Inverse heat operation being added as shown in Fig. 51.2.2.

![]({{ '/assets/images/inverse_heat_wizard/51_2_3d_inverse_heat_manual/image0001.jpg' | relative_url }})

Opening 3D Inverse heat Wizard from GUI Main

![]({{ '/assets/images/inverse_heat_wizard/51_2_3d_inverse_heat_manual/image0002.jpg' | relative_url }})

3D Inverse Heat Wizard

## Initialization

In this page user have options to import wizard file using ![]({{ '/assets/icons/pre_icons/mo_import_wizard_file_button.jpg' | relative_url }}) button, “*.IHWZ” file will be imported as shown in the Fig. 51.2.3. In Sim mode tab , depending on the requirement user can turn on the Phase transformation check box to include phase transformation calculations and Diffusion check box to include atom diffusion while estimating the Heat transfer Coefficients (HTC).

![]({{ '/assets/images/inverse_heat_wizard/51_2_3d_inverse_heat_manual/image0003.jpg' | relative_url }})

Initialization page

## Process condition

In Inverse HT wizard user can model both heat transfer while transferring to quench and then Quench. Depending on the requirement user can select any one or both processes. Heat transfer operation will be simulated first followed by quenching. User need to define the environment temperature data for the selected process as shown in the Fig. 51.2.4. The environment temperature can be defined as a constant or function of time.

![]({{ '/assets/images/inverse_heat_wizard/51_2_3d_inverse_heat_manual/image0004.jpg' | relative_url }})

Process condition page

## Material List

In this Material List page, user can load the material for the Workpiece using Import Material data from a File ![]({{ '/assets/icons/pre_icons/mo_import_file_icon.jpg' | relative_url }}) or using Load form Library option ![]({{ '/assets/icons/pre_icons/mo_load_from_library_icon.jpg' | relative_url }}). If user has created a new material, then user can save the material using ![]({{ '/assets/icons/pre_icons/mo_save_to_a_file_icon.jpg' | relative_url }}), ![]({{ '/assets/icons/pre_icons/mo_save_to_library_icon.jpg' | relative_url }}) buttons.(See Fig. 51.2.5.)

![]({{ '/assets/images/inverse_heat_wizard/51_2_3d_inverse_heat_manual/image0005.jpg' | relative_url }})

Material List Page

## Workpiece object page

In Workpiece page, user can define object name, object initial temperature and object type of a workpiece as shown in the Fig. 51.2.6. The object type is selected as “Plastic” by default, if user is interested to consider the effect of elastic properties then Elasto-plastic object type can be used. User can import objects from other databases or key files using ![]({{ '/assets/icons/pre_icons/mo_import_file_icon.jpg' | relative_url }}), ![]({{ '/assets/icons/pre_icons/mo_load_from_library_icon.jpg' | relative_url }}) options or save the object data using ![]({{ '/assets/icons/pre_icons/mo_save_to_a_file_icon.jpg' | relative_url }}), ![]({{ '/assets/icons/pre_icons/mo_save_to_library_icon.jpg' | relative_url }}) options.

![]({{ '/assets/images/inverse_heat_wizard/51_2_3d_inverse_heat_manual/image0006.jpg' | relative_url }})

Workpiece Object page

### Geometry page

The geometry can be imported from a file using ![]({{ '/assets/icons/pre_icons/mo_import_file_icon.jpg' | relative_url }}), ![]({{ '/assets/icons/pre_icons/mo_load_from_library_icon.jpg' | relative_url }}) options or can be created from the primitives. Modifications to the imported or created geometry can be made using ![]({{ '/assets/icons/pre_icons/mo_edit_lable.jpg' | relative_url }}) option. The geometry can be saved using ![]({{ '/assets/icons/pre_icons/mo_save_to_a_file_icon.jpg' | relative_url }}), ![]({{ '/assets/icons/pre_icons/mo_save_to_library_icon.jpg' | relative_url }}) options. (See Fig. 51.2.7.)

![]({{ '/assets/images/inverse_heat_wizard/51_2_3d_inverse_heat_manual/image0007.jpg' | relative_url }})
...
For more detail description of these options, please refer [3D Mesh](/docs/en/pre_processor/13_mesh_generation/13_2_3d_tet_mesh_generation/).
...
The user can define the temperature measurement points by clicking on add button and selecting the point on the workpiece as shown in the Fig. 51.2.13. The user can define the thermal data measured from experiments for the respective point using ![]({{ '/assets/icons/pre_icons/mo_inverse_heat_define_button.jpg' | relative_url }}) button as shown in the Fig. 51.2.14. or we can import the .DAT file containing the thermal data using the ![]({{ '/assets/icons/post_icons/mo_import_button.jpg' | relative_url }}) option.. We can also save the defined thermal data using the ![]({{ '/assets/icons/pre_icons/mo_save_icon.jpg' | relative_url }}) button. After defining the thermal data, the ![]({{ '/assets/icons/pre_icons/mo_inverse_heat_define_button.jpg' | relative_url }}) button will change to ![]({{ '/assets/icons/pre_icons/mo_inverse_heat_edit_button.jpg' | relative_url }})button. 

  
The ![]({{ '/assets/icons/pre_icons/mo_exam_ all_button.jpg' | relative_url }}) button is used to display experimental temperature curves at all points as shown in the Fig. 51.2.15. User can plot the temperature curves selectively by turning on or off the respective measurement points check boxes, “Hide All” and “Select All” buttons can be used to hide or display curves at all measurement points respectively.
...
![]({{ '/assets/images/inverse_heat_wizard/51_2_3d_inverse_heat_manual/image0013.jpg' | relative_url }})

Temperature Measurement Points Page

![]({{ '/assets/images/inverse_heat_wizard/51_2_3d_inverse_heat_manual/image0014.jpg' | relative_url }})

Defining the Thermal Data by using Define button

![]({{ '/assets/images/inverse_heat_wizard/51_2_3d_inverse_heat_manual/image0015.jpg' | relative_url }})

Display of all points thermal data using Exam all button

## Time Zones

Time zone page provides option to define the duration of the selected processes in “Process Condition” page. If user has selected both processes, then “End time” of the “Transfer” process is automatically assigned to the “Start time” of the Quench, see Fig. 51.2.16. and Fig. 51.2.17. If user clicks on ![]({{ '/assets/icons/pre_icons/mo_next_button.jpg' | relative_url }}) button without defining any data, then “End time” will be assigned as 10 secs. Display area displays the graph with temperature curves of all measurement points, a vertical line can be observed when both the processes are used indicating the end of “Transfer” process and start of “Quench”.

![]({{ '/assets/images/inverse_heat_wizard/51_2_3d_inverse_heat_manual/image0016.jpg' | relative_url }})

Time zone for only the Transfer process

  
![]({{ '/assets/images/inverse_heat_wizard/51_2_3d_inverse_heat_manual/image0017.jpg' | relative_url }})

Time zone for both Transfer and Quench process

## Heat Transfer Zones

In “Heat Transfer Zones” page”, click ![]({{ '/assets/icons/pre_icons/mo_add_htc_zone_button.jpg' | relative_url }}) button. To define heat transfer zone, first select the appropriate row in the table and then pick surfaces on the object. Zones are the continuous surfaces which are exposed to similar conditions. We may need to use the picking options in the lower tool bar in order to achieve ideal picking results as shown in the Fig. 51.2.18.

**Note:** The symmetric planes should not be included in any heat transfer zone.

![]({{ '/assets/images/inverse_heat_wizard/51_2_3d_inverse_heat_manual/image0018.jpg' | relative_url }})

Heat Transfer Zones page

#### Heat Transfer Coefficient Function Definition

![]({{ '/assets/icons/pre_icons/mo_iniitialize_htc_button.jpg' | relative_url }}) button (see Fig. 51.2.19.) can be used to initialize the HTC values for all zones. Once the user clicks on “Initialize HTC” button it opens Heat Transfer Coefficient Function Definition page as shown in Fig. 51.2.19. User can define the control points that can be used to construct temperature or time dependent HTC function. User can set the initial guess value, the minimum and maximum values for the heat transfer coefficients. Once the user initializes the data, user can modify the values for each zone independently using ![]({{ '/assets/icons/pre_icons/mo_edit..._button.jpg' | relative_url }}) button as shown in Fig. 51.2.20. Defining a reasonable initial HTC guess values helps the DEFORM optimization routines to get to the desired results quicker. For example, defining a huge range of lower and upper bound heat transfer values for a heat treat process, and an unreasonably higher or lower initial guess, which is not representative of the quench process, would drive the optimization routine to take a longer time to solve the problem.

![]({{ '/assets/images/inverse_heat_wizard/51_2_3d_inverse_heat_manual/image0019.jpg' | relative_url }})

Heat Transfer Coefficient Function Definition page

![]({{ '/assets/images/inverse_heat_wizard/51_2_3d_inverse_heat_manual/image0020.jpg' | relative_url }})

Defined Function data page

## Positioning

User can position the objects using ![]({{ '/assets/icons/pre_icons/mo_positioning_objects_button.jpg' | relative_url }}) button. Various positioning options are available to position the objects as shown in Fig. 51.2.21., for more information on these options please refer [3D Positioning objects](/docs/en/pre_processor/19_object_positioning/19_object_positioning/)
...
The user can define the step definition data for the selected process. If we select any one process, then the respective process step definition will be as shown in the Fig. 51.2.22. If we select both the process, then the transfer and quench step definition will be as shown in the Fig. 51.2.23.  
...
**Temperature (DTPMAX)** : If user selects the temperature-based step increment, then the time interval for step increment is controlled by the settings defined as shown in Fig. 51.2.22..
...
![]({{ '/assets/images/inverse_heat_wizard/51_2_3d_inverse_heat_manual/image0022.jpg' | relative_url }})

Step controls for Transfer Process

  
![]({{ '/assets/images/inverse_heat_wizard/51_2_3d_inverse_heat_manual/image0023.jpg' | relative_url }})

Step controls for both Transfer and Quench process

## Optimization Controls

In Optimization Control user can define the criteria to stop the optimization as show in the Fig. 51.2.24.  
**Stopping Controls:**
...
![]({{ '/assets/images/inverse_heat_wizard/51_2_3d_inverse_heat_manual/image0024.jpg' | relative_url }})
...
**Generate Database![]({{ '/assets/icons/pre_icons/mo_generate_database.jpg' | relative_url }}) : **By clicking on this button, system generates the Database for the setup (See Fig. 51.2.25.).
...
![]({{ '/assets/images/inverse_heat_wizard/51_2_3d_inverse_heat_manual/image0025.jpg' | relative_url }})

Generate DB page

## Post-Processing the Inverse HT Optimized results

Once the optimization is completed, we can notice that there will be two DBs in the project folder, one with Project_INI.DB and other one as Project_Optimized.DB. The Project_INI.DB has initial settings defined while generating the database while Project_Optimized.DB has optimized HTCs. When user shifts to POST tab in Inverse HT wizard, we can notice two icons as shown in Fig. 51.2.26.

![]({{ '/assets/images/inverse_heat_wizard/51_2_3d_inverse_heat_manual/image0026.jpg' | relative_url }})

3D Inverse Heat post processor

  
**Local Objectives![]({{ '/assets/icons/pre_icons/mo_inverse_heat_local_objective_button.jpg' | relative_url }}) :**  
![]({{ '/assets/icons/pre_icons/mo_inverse_heat_local_objective_button.jpg' | relative_url }}) is used to plot the experimental temperature values and predicted values in optimized solution. . When user clicks on the ![]({{ '/assets/icons/pre_icons/mo_inverse_heat_local_objective_button.jpg' | relative_url }}) icon it opens window as shown in Fig. 51.2.27., user can click on ![]({{ '/assets/icons/pre_icons/mo_inverse_heat_view_all_button.jpg' | relative_url }}) button to display the experimental and predicted temperature curves. The plotted graphs have display controls to control the display of curves for selected points as shown in Fig. 51.2.27.

![]({{ '/assets/images/inverse_heat_wizard/51_2_3d_inverse_heat_manual/image0027.jpg' | relative_url }})
...
![]({{ '/assets/icons/pre_icons/mo_inverse_heat_optimal_htc.jpg' | relative_url }}) is used to plot the HTC values for each zone defined in the pre-processor as function of temperature or time from the optimized solution, see Fig. 51.2.28. The HTC values can be exported from the graph and can be used in simulation of quenching or other heat treatment processes.

![]({{ '/assets/images/inverse_heat_wizard/51_2_3d_inverse_heat_manual/image0028.jpg' | relative_url }})
