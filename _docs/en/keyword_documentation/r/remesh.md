...
RELATED TOPICS  
---  
Text-based PRE, Shape optimization, [Multiple operations](/docs/en/integrated_manufacturing_process_setup/5_introduction_to_integrated_manufacturinghtm/) Keywords: [BRDEXT](/docs/en/keyword_documentation/b/brdext/), [DEFINT](/docs/en/keyword_documentation/d/defint/), [DEFAMG](/docs/en/keyword_documentation/d/defamg/)
