...
Num(1), node1(1) node2(1) node3(1) node4(1) BCAtom(1)

: :

Num(Ndata), node1(Ndata) node2(Ndata) node3(Ndata) node4(Ndata) BCAtom(Ndata)
...
DefBCAtom |  Default carbon boundary constraint code of all faces not listed in node/boundary constraint data pairs |  0  
