...
RELATED TOPICS  
---  
Object Edge data: [Diffusion](/docs/en/pre_processor/10_material_data/10_4_diffusion_data/10_4_diffusion_data/) Keywords: [ECCATM(2D),](/docs/en/keyword_documentation/e/eccatm/) [ECCATM (3D)](/docs/en/keyword_documentation/e/eccatm_3d/), [ECTMFN (2D)](/docs/en/keyword_documentation/e/ectmfn/), [ECTMFN (3D)](/docs/en/keyword_documentation/e/ectmfn_3d/)
