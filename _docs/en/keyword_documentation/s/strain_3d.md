...
REMARKS  
---  
The keyword format varies depending on strain output selection made at [ELMNOD](/docs/en/keyword_documentation/e/elmnod/). For element output ([ELMNOD](/docs/en/keyword_documentation/e/elmnod/) = 0) option, effective strain at the centroid of each element is written. For dual output ([ELMNOD](/docs/en/keyword_documentation/e/elmnod/) = 2) option, effective strain at the centroid of element and at node are written. For brick element case with integration point ([ELMNOD](/docs/en/keyword_documentation/e/elmnod/) = 3) option, effective strain values at eight integration points in element are written. Note: This integration point option is valid only for brick element whose strain values are evaluated at 8 integration points per element during FEM calculation. For Tetrahedral element, integration point output option is same as elemental output option.  Applicable object types:[Plastic](../../pre_processor/11_general_object_data_definition/11_general_object_data_definition.htm#11.4.1_Plastic), [Elastoplastic](../../pre_processor/11_general_object_data_definition/11_general_object_data_definition.htm#11.4.3._Elasto-plastic), [Porous](../../pre_processor/11_general_object_data_definition/11_general_object_data_definition.htm#11.4.4._Porous)  
  
RELATED TOPICS  
---  
Related keywords: [ELMNOD (2D3D)](/docs/en/keyword_documentation/e/elmnod/)
