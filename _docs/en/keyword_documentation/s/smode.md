...
RELATED TOPICS  
---  
Simulation Controls: [Main Controls](/docs/en/pre_processor/9_simulation_controls/9_1_simulation_type_settings/) \- [Modes](../../pre_processor/9_simulation_controls/9_1_simulation_type_settings.htm#9.1.5._Simulation_modes_\(SMODE,_TRANS\)) Related keywords: [TRANS](/docs/en/keyword_documentation/t/trans/), [STYPE (2D)](/docs/en/keyword_documentation/s/stype/), [STYPE (3D)](/docs/en/keyword_documentation/s/stype_3d/)
