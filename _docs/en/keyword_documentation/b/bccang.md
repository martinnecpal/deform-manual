...
RELATED TOPICS  
---  
[Boundary constraints](/docs/en/pre_processor/14_boundary_conditions/14_boundary_conditions/) Keywords: [URZ (2D)](/docs/en/keyword_documentation/u/urz/), [FRZ (2D)](/docs/en/keyword_documentation/f/frz/), [URZ (3D)](/docs/en/keyword_documentation/u/urz_3d/), [FRZ (3D)](/docs/en/keyword_documentation/f/frz_3d/),
