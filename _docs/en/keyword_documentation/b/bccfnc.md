...
RELATED TOPICS  
---  
[Boundary constraints](/docs/en/pre_processor/14_boundary_conditions/14_boundary_conditions/) Keywords: [BCCDEF(2D)](/docs/en/keyword_documentation/b/bccdef/), [BCCDEF(3D)](/docs/en/keyword_documentation/b/bccdef_3d/), [BCCDFN(2D)](/docs/en/keyword_documentation/b/bccdfn/), [BCCDFN(3D)](/docs/en/keyword_documentation/b/bccdfn_3d/), [BCCTMP](/docs/en/keyword_documentation/b/bcctmp/), [BCCTFN](/docs/en/keyword_documentation/b/bcctfn/).
