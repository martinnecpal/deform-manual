...
RELATED TOPICS  
---  
[Geometry](../../pre_processor/12_geometry_modelling): Topology Keywords: [DIEGEO (2D)](/docs/en/keyword_documentation/d/diegeo/), [DIEGEO (3D)](/docs/en/keyword_documentation/d/diegeo_3d/)
