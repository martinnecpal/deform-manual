...
RELATED TOPICS  
---  
[Object Properties](/docs/en/pre_processor/16_object_properties/16_object_properties/): [Deformation](/docs/en/pre_processor/16_object_properties/16_1_deformation_properties/) \- [Target Volume](../../pre_processor/16_object_properties/16_1_deformation_properties.htm#16_1_3_Target_Volume_\(TRGVOL\)) Related keywords:[GEOTYP(2D)](/docs/en/keyword_documentation/g/geotyp/) , [OBJTYP(2D)](/docs/en/keyword_documentation/o/objtyp/), [OBJTYP(3D)](/docs/en/keyword_documentation/o/objtyp_3d/)
