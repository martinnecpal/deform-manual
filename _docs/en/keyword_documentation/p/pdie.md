...
RELATED TOPICS  
---  
[Primary object](../../pre_processor/9_simulation_controls/9_2_defining_step.htm#Primary_die_\(PDIE\)), [Movement control](/docs/en/pre_processor/15_movement_controls_definition/15_movement_controls_settings/), [Termination parameters](/docs/en/pre_processor/9_simulation_controls/9_3_stopping_controls/), [Step parameters](/docs/en/pre_processor/9_simulation_controls/9_2_defining_step/). Keywords: [SMAX](/docs/en/keyword_documentation/s/smax/), [VMIN](/docs/en/keyword_documentation/v/vmin/), [LMAX (2D)](/docs/en/keyword_documentation/l/lmax/), [LMAX (3D)](/docs/en/keyword_documentation/l/lmax_3d/), [MOVCTL (2D)](../m/movctl_\(2d\).htm), [MOVCTL (3D)](../m/movctl_\(3d\).htm), [DSMAX](/docs/en/keyword_documentation/d/dsmax/)
