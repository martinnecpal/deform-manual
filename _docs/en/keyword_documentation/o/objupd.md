...
RELATED TOPICS  
---  
Simulation Controls: [Simulation Type](/docs/en/pre_processor/9_simulation_controls/9_1_simulation_type_settings/), [Ring Rolling Wizard](/docs/en/operation_templates/42_ring_rolling/42_introduction_to_ring_rolling/), [Shape Rolling Wizard](/docs/en/operation_templates/43_shape_rolling/43_introduction_to_shape_rolling/)
