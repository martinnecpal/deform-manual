...
The keywords [MGWCUV](/docs/en/keyword_documentation/m/mgwcuv/), [MGWSTN](/docs/en/keyword_documentation/m/mgwstn/), [MGWSTR](), [MGWTMP](/docs/en/keyword_documentation/m/mgwtmp/), and MGWUSR specify relative mesh density weights to be assigned to the associated keyword parameter (curvature, strain, strain rate, temperature, and user defined area).   
...
RELATED TOPICS  
---  
[Mesh](/docs/en/pre_processor/13_mesh_generation/13_mesh_generation/): Mesh weighting factors Keywords: [MGWTMP](/docs/en/keyword_documentation/m/mgwtmp/), [MGWCUV](/docs/en/keyword_documentation/m/mgwcuv/), [MGWSTR](), [MGWUSR(2D)](/docs/en/keyword_documentation/m/mgwusr/), [MGUSER (3D)](/docs/en/keyword_documentation/m/mguser_3d/), [MGNELM(2D)](/docs/en/keyword_documentation/m/mgnelm/), [MGNELM (3D)](/docs/en/keyword_documentation/m/mgnelm_3d/), [MGGRID](/docs/en/keyword_documentation/m/mggrid/), [MGERR](/docs/en/keyword_documentation/m/mgerr/), [MGTELM](/docs/en/keyword_documentation/m/mgtelm/), [MGSIZR](/docs/en/keyword_documentation/m/mgsizr/)
