...
RELATED TOPICS  
---  
Simulation Controls: [Stopping Controls](/docs/en/pre_processor/9_simulation_controls/9_3_stopping_controls/) Keywords: [REFPOS](/docs/en/keyword_documentation/r/refpos_3d/)
