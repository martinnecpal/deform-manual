...
REMARKS  
---  
These state variables are computed only when the material is anisotropic. Related keyword: [ANISO](/docs/en/keyword_documentation/a/aniso/).  
  
RELATED TOPICS  
---  
[Object Element Data](/docs/en/pre_processor/17_object_data_initialization/17_2_element_data_window/): Deformation- General Keywords: [ANISO](/docs/en/keyword_documentation/a/aniso/)
