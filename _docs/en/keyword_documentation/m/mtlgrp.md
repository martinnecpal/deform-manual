...
RELATED TOPICS  
---  
[Material properties](/docs/en/pre_processor/10_material_data/10_material_data/) Keywords: [EMSVTY](/docs/en/keyword_documentation/e/emsvty/), [EXPAND](/docs/en/keyword_documentation/e/expand/), [FRAE2H](/docs/en/keyword_documentation/f/frae2h/), [FSTRES](/docs/en/keyword_documentation/f/fstres/), [HEATCP](/docs/en/keyword_documentation/h/heatcp/), [MTNAME](/docs/en/keyword_documentation/m/mtname/), [POISON](/docs/en/keyword_documentation/p/poison/), [YOUNG](/docs/en/keyword_documentation/y/young/)
