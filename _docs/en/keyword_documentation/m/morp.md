...
REMARKS  
---  
This is action keyword which will create DEF_MORP2.INI and spawn DEF_MPRP2.EXE. The newly created geometry as a result of morphing will be loaded by action keyword [GFREAD](/docs/en/keyword_documentation/g/gfread/). If nominal/source object has mesh, new mesh will be created from action keyword [DEFAMG](/docs/en/keyword_documentation/d/defamg/). DOE variable numbers will be converted to weighting factors by parsing.  
  
RELATED TOPICS  
---  
Related keywords: [GFREAD](/docs/en/keyword_documentation/g/gfread/), [DEFAMG](/docs/en/keyword_documentation/d/defamg/)
