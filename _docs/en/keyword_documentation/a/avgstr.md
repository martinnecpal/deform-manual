...
RELATED TOPICS  
---  
Object Properties: [Deformation](/docs/en/pre_processor/16_object_properties/16_1_deformation_properties/)  
Keywords: [LMTSTR](/docs/en/keyword_documentation/l/lmtstr/)  
