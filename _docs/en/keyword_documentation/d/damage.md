...
|  (Object Data)  
---|---  
_Update History:_ (New) Definition has been extended in v11 V11 – Integration Point output option has been added for 2D Quad element. |  Last updated on : 29-07-2013  
...
NDim |  Number of (multiple) damage models |  1  
Ndata |  Number of element/damage pairs |  None  
DefDamage |  Default elemental damage value |  0  
...
RELATED TOPICS  
---  
Related keywords: [ELMNOD](/docs/en/keyword_documentation/e/elmnod/), [FRCMOD](/docs/en/keyword_documentation/f/frcmod/)
