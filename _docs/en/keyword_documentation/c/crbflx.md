...
RELATED TOPICS  
---  
Boundary constraints, Inter-object contact Keywords: [DATOM](/docs/en/keyword_documentation/d/datom/), [BCCCRB(2D)](/docs/en/keyword_documentation/b/bcccrb/), .[BCCCRB(3D)](/docs/en/keyword_documentation/b/bcccrb_3d/)
