...
RELATED TOPICS  
---  
Simulation Mode: Heat transfer, Heating, Induction Object Properties: [Induction Heating](/docs/en/pre_processor/16_object_properties/16_6_heating_properties/) Keywords: [VOLCRG](/docs/en/keyword_documentation/v/volcrg/)
