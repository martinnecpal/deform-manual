...
RELATED TOPICS  
---  
[Boundary Conditions](/docs/en/pre_processor/14_boundary_conditions/14_boundary_conditions/): Advanced Deformation Keywords: [ECCDEF (2D)](/docs/en/keyword_documentation/e/eccdef/), [ECCDEF (3D)](/docs/en/keyword_documentation/e/eccdef_3d/)
