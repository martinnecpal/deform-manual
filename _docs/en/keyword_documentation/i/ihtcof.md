...
RELATED TOPICS  
---  
[Inter-Object Conditions](/docs/en/pre_processor/20_inter-object_data_definition/20_inter-object_data_definition/): Thermal Keywords: [CNTACT (2D)](/docs/en/keyword_documentation/c/cntact/), [CNTACT (3D)](/docs/en/keyword_documentation/c/cntact_3d/), [FRCROT(2D)](/docs/en/keyword_documentation/f/frcrot/)
