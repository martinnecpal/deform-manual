...
RELATED TOPICS  
---  
[DEFORM-HT](/docs/en/operation_templates/37_heat_treatment/37_introduction_to_heat_treatment/) Keywords: [GRNDAT](/docs/en/keyword_documentation/g/grndat/), [GRAIN](/docs/en/keyword_documentation/g/grain/)
