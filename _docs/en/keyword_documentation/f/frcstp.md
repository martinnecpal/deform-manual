...
RELATED TOPICS  
---  
[Flow stress](/docs/en/pre_processor/10_material_data/10_1_plastic_data/10_1_1_flowstress/10_1_1_flow_stress_models/), [Fracture](/docs/en/pre_processor/10_material_data/10_12_miscellaneous_data/10_12_1_fracture_models/) Keywords: [DAMAGE (2D)](/docs/en/keyword_documentation/d/damage/), [DAMAGE (3D)](/docs/en/keyword_documentation/d/damage_3d/), [FRCMOD](/docs/en/keyword_documentation/f/frcmod/), [FRCNEL (2D)](/docs/en/keyword_documentation/f/frcnel/), [FRCNEL (3D)](/docs/en/keyword_documentation/f/frcnel_3d/), [FRCMTH (2D)](/docs/en/keyword_documentation/f/frcmth/)
