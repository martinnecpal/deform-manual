...
RELATED TOPICS  
---  
Material Data: [Hardness](/docs/en/pre_processor/10_material_data/10_7_hardness_data/10_7_hardness_data/) Keyword: [HDNOBJ](/docs/en/keyword_documentation/h/hdnobj/), [HDNEST](/docs/en/keyword_documentation/h/hdnest/), [HDNTIM](/docs/en/keyword_documentation/h/hdntim/), [JOMINY](/docs/en/keyword_documentation/j/jominy/)
