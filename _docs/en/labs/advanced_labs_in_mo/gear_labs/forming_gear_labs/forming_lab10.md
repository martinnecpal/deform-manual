...
Open the Project **Gear_LargerBillet**.

### Add Die stress study

In this lab we will preform Die stress operation for the dies using Die stress study operation, So click on ![]({{ '/assets/icons/pre_icons/mo_add_operation_icon.jpg' | relative_url }}) button available at Top Left corner of the graphics window and select Die stress study in list (See Fig. L10.1.).

![]({{ '/assets/images/labs/advanced_labs_in_mo/gear_labs/forming_gear_labs/lab10_image0001.jpg' | relative_url }})

Adding Die stress study from list

### Step selection

Select the last step in step list (See Fig. L10.2.), then click ![]({{ '/assets/icons/pre_icons/mo_next_button.jpg' | relative_url }}) until top die general page.

![]({{ '/assets/images/labs/advanced_labs_in_mo/gear_labs/forming_gear_labs/lab10_image0002.jpg' | relative_url }})
...
![]({{ '/assets/images/labs/advanced_labs_in_mo/gear_labs/forming_gear_labs/lab10_image0009.jpg' | relative_url }})
...
In Material window, load **AISI-H-13** material from material library and assign it to Top Die, Click ![]({{ '/assets/icons/pre_icons/mo_next_button.jpg' | relative_url }}) to BCC page.
...
![]({{ '/assets/images/labs/advanced_labs_in_mo/gear_labs/forming_gear_labs/lab10_image0004.jpg' | relative_url }})
...
![]({{ '/assets/images/labs/advanced_labs_in_mo/gear_labs/forming_gear_labs/lab10_image0003.jpg' | relative_url }})
...
![]({{ '/assets/images/labs/advanced_labs_in_mo/gear_labs/forming_gear_labs/lab10_image0010.jpg' | relative_url }})
...
In Material window, select **AISI-H-13** material from material page and Click ![]({{ '/assets/icons/pre_icons/mo_next_button.jpg' | relative_url }}) to BCC page.

#### Assign BCC for Bottom die

In BCC page, check the default assigned Deformation BCC for Left side of the Bottom die in **X-Direction** , then Apply**Vy = 0** Velocity boundary condition on the Bottom surface of the bottom die (See Fig. L10.7.). Click ![]({{ '/assets/icons/pre_icons/mo_next_button.jpg' | relative_url }}) to Force interpolation page.

![]({{ '/assets/images/labs/advanced_labs_in_mo/gear_labs/forming_gear_labs/lab10_image0006.jpg' | relative_url }})

Bottom die BCC page

#### Interpolate Force for Bottom die 

In Force interpolation page, click on ![]({{ '/assets/icons/pre_icons/mo_interpolate_force_button.jpg' | relative_url }}) action label to interpolate forces as shown in Fig. L10.8.

![]({{ '/assets/images/labs/advanced_labs_in_mo/gear_labs/forming_gear_labs/lab10_image0005.jpg' | relative_url }})
...
![]({{ '/assets/images/labs/advanced_labs_in_mo/gear_labs/forming_gear_labs/lab10_image0007.jpg' | relative_url }})
...
![]({{ '/assets/images/labs/advanced_labs_in_mo/gear_labs/forming_gear_labs/lab10_image0008.jpg' | relative_url }})

Max Principal Stress state variable plot

Switch to ![]({{ '/assets/icons/pre_icons/mo_post_mode_button.jpg' | relative_url }}) mode and add another Die stress study to add Shrink Fit. Click [Lab 11. Die stres with a press fit.](/docs/en/labs/advanced_labs_in_mo/gear_labs/forming_gear_labs/forming_lab11/) to continue Shrink fit lab.
