...
For details on using other sections of the [Report generation](/docs/en/operation_templates/41_report_generation/41_1_report_generation/) refer the related topics.
