...
In order to continue with the Die Stress lab for this problem do not close the MO project Refer the [Lab 06 Die Stress](/docs/en/labs/basic_labs/2d_labs/lab_06_die_stress/).
