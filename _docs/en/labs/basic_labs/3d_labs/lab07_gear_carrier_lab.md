...
The previous lab, [Lab04: Steering Link](/docs/en/labs/basic_labs/3d_labs/lab04_steering_link/), explained the mesh settings in detail which are used to optimize execution time and problem resolution.
