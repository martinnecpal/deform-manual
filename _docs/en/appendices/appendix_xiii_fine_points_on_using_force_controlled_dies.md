...
In many simulations, force-controlled dies are used in order to simulate real-world tool loading conditions. As seen in [Appendix XII](/docs/en/appendices/appendix_xii__modelling_of_spring_loaded_die/), these can be used in order to simulate spring-loaded dies. The purpose of this section is to explain the pitfalls that can occur while trying to simulate force-loaded dies in terms of obtaining good results and improving convergence of the solution
...
[Movement Controls Definition-Force](/docs/en/pre_processor/15_movement_controls_definition/15_2_force/)
