...
Refer [Appendix XVI: Adding Gas Trap Calculation to a Simulation for more information](/docs/en/appendices/appendix_xvi_adding_gas_trap_calculation_to_a_simulation/).
...
Refer [Appendix XV: The Double Concave Corner Constraint](/docs/en/appendices/appendix_xv_the_double_concave_corner_constraint/) for more information.
