...
Pre-processor offers dual definitions, unified [simulation controls](/docs/sk/pre_processor/9_simulation_controls/9_simulation_controls/), built in conversion module and model conversion from 2D to 3D.
