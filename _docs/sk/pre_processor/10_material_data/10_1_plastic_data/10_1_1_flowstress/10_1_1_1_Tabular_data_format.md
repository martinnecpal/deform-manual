---
lang: sk
title: "10.1.1.1. Formát tabuľkových údajov"
---

# 10.1.1.1. Formát tabuľkových údajov

Tabuľkový formát je najuniverzálnejším formátom, pretože môže reprezentovať akýkoľvek materiál, v ktorom možno napätie pri prúdení uviesť ako funkciu deformácie, rýchlosti deformácie a teploty.

![](../../../../../assets/Equations/Pre_Processor/10_Material_Data/10_1_Plastic_Data/10_1_1_FlowStress/EQ_10_1_1_1.JPG) |
---|---
  
**Interpolačné metódy:** Pre tabuľkové údaje sú k dispozícii dva typy interpolačných metód,

  * **Lineárna interpolácia:** Hodnoty prietokového napätia sa interpolujú lineárne v priestore deformácie, rýchlosti deformácie a teploty.
  * **Log interpolácia:** Hodnoty prietokového napätia sú interpolované v logaritmickom priestore deformácie, logaritmickej rýchlosti deformácie a lineárnej teploty. Pre dátové body pri plastickej deformácii 0,0 sa medzi hodnotou 0 a prvou hodnotou, ktorá nie je 0, použije lineárna interpolácia a pre nasledujúce hodnoty sa použije logaritmická interpolácia.
