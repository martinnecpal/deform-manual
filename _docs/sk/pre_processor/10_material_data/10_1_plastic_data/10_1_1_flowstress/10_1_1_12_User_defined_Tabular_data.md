---
lang: sk
title: "10.1.1.12. Tabuľkové údaje definované používateľom"
---

# 10.1.1.12. Tabuľkové údaje definované používateľom

Používateľ môže definovať funkciu flowstress ako ľubovoľnú kombináciu dostupných vstupných premenných teplota, napätie, deformácia, čas, rýchlosť deformácie, veľkosť zrazeniny, tvar zrazeniny a objemový podiel zrazeniny, ako je znázornené na nasledujúcom obr. 10.1.1.12.1.
...
Tabuľka toku údajovokno definície funkcie modelu napätia

  
Používateľ si môže zobraziť graf výberom karty Zobrazenie grafu. Hodnoty prietokového napätia sú lineárne interpolované v priestore funkčných premenných, ako je znázornené na nasledujúcom obr. 10.1.1.12.2.
...
Tabuľka toku údajovokno zobrazenia grafu napätia
