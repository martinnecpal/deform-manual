---
lang: sk
title: "10.1.1.13. Tabuľkové údaje definované používateľom (protokol)"
---

# 10.1.1.13. Tabuľkové údaje definované používateľom (protokol)

Používateľ môže definovať funkciu flowstress ako ľubovoľnú kombináciu dostupných vstupných premenných teplota, napätie, deformácia, čas, rýchlosť deformácie, veľkosť zrazeniny, tvar zrazeniny a objemový podiel zrazeniny. Používateľ si môže zobraziť graf výberom záložky Graph view (Zobrazenie grafu). Hodnoty Flowstress (Prietokové napätie) sú logaritmicky interpolované v priestore premenných funkcie.
