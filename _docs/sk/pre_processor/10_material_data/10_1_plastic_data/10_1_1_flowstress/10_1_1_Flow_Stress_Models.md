...
DEFORM provides different methods of defining the flow stress ([FSTRES](/docs/sk/Keyword_Documentation/F/FSTRES/)) as shown in Fig. 10.1.1.1. Use the links below to know more about different types of flow stress models available in DEFORM.
