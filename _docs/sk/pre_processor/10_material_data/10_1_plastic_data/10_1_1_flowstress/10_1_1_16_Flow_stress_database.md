---
lang: sk
title: "10.1.1.16. Databáza prietokového napätia"
---

# 10.1.1.16. Databáza prietokového napätia

Databáza materiálov DEFORM obsahuje údaje o napätí pri prúdení pre viac ako 200 rôznych materiálov. Údaje o napätí pri prúdení, ktoré poskytuje databáza materiálov, majú obmedzený rozsah, pokiaľ ide o rozsah teplôt a efektívnu deformáciu.

  
**Upozornenie:**

Ak simulačné podmienky materiálu prekročia hranice deformácie, rýchlosti deformácie alebo teploty definované v tabuľkových údajoch, program bude extrapolovať na základe posledných dvoch dátových bodov, čo môže viesť k strate presnosti.
