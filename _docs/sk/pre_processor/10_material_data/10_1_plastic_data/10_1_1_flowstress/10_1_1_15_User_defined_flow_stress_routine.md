---
lang: sk
title: "10.1.1.15.Používateľom definovaná rutina zaťaženia toku"
---

# 10.1.1.15. Používateľom definovaná rutina zaťaženia toku

Okrem uvedených modelov napätia pri prúdení systém DEFORM umožňuje flexibilitu, s ktorou môže používateľ implementovať do systému vlastné modely napätia pri prúdení pomocou používateľských procedúr, vytvoriť vlastný motor konečných prvkov a použiť ho na spustenie deformačného modelu. Pri definovaní vlastných modelov napätia prúdenia môžu mať používatelia prístup ku všetkým uzlovým a prvkovým stavovým premenným. V závislosti od materiálového modelu usr_mtr.f fortranového súboru musí používateľ zadať číslo používateľskej rutiny, ako je znázornené na obr. 10.1.1.15.1.
...
Okno používateľskej rutiny Flow stress

  
Popis implementácie používateľsky definovaných procedúr záťaže toku nájdete v časti [Chapter 56. User Routines](/docs/sk/User_Routines/56_User_Routines_in_DEFORM/56_User_Routines_in_DEFORM/).
