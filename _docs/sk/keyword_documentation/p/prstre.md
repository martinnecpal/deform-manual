...
RELATED TOPICS  
---  
[Movement Controls](/docs/sk/pre_processor/15_movement_controls_definition/15_movement_controls_settings/): Elastic Losses Keywords: [MOVCTL (2D)](../m/movctl_\(2d\).htm), [MOVCTL (3D)](../m/movctl_\(3d\).htm)
