...
DefZSpeed |  Default nodal speed in Z of all nodes not listed in the node/speed pairs |  0  
...
RELATED TOPICS  
---  
[Boundary Constraints](/docs/sk/pre_processor/14_boundary_conditions/14_boundary_conditions/): [Deformation](/docs/sk/pre_processor/14_boundary_conditions/14_2_deformation_boundary_conditions/) \- [Velocity](../../pre_processor/14_boundary_conditions/14_2_deformation_boundary_conditions.htm#14.2.1._Velocity_BCC) Keywords: [BCCANG](/docs/sk/keyword_documentation/b/bccang/),[BCCDEF(2D)](/docs/sk/keyword_documentation/b/bccdef/),[BCCDEF(3D)](/docs/sk/keyword_documentation/b/bccdef_3d/), [MOVCTL(2D)](../m/movctl_\(2d\).htm), [MOVCTL(3D)](../m/movctl_\(3d\).htm)
