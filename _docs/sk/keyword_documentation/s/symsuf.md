...
RELATED TOPICS  
---  
Boundary Constraints: [Symmetry Constraints](/docs/sk/pre_processor/14_boundary_conditions/14_1_symmetry_boundary_conditions/) Keywords: [ROTSYM](../r/rotsym_\(3d\).htm)
