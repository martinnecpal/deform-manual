...
RELATED TOPICS  
---  
[Inter-Object data](/docs/sk/pre_processor/20_inter-object_data_definition/20_inter-object_data_definition/): Friction Window Keywords: [FRCFAC](/docs/sk/keyword_documentation/f/frcfac/)
