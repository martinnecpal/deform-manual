...
FRZ Object, Ndata, DefXForce, DefYForce, DefZForce

Node(1), XForce(1), YForce(1 , ZForce(1)

: : : :

Node(Ndata), XForce(Ndata), YForce(Ndata), ZForce(Ndata)
...
DefZForce |  Default nodal force in Z for all nodes not listed in the node/force sets |  0.0  
...
ZForce(i) |  Nodal force in Z of ith data set |  0.0  
