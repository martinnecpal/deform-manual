...
RELATED TOPICS  
---  
Keywords: [ANGMOV(2D)](/docs/sk/keyword_documentation/a/angmov/), [ANGMOV(3D)](../a/angmov\(3d\).htm),[MOVCTL (2D)](../m/movctl_\(2d\).htm), [MOVCTL (3D)](../m/movctl_\(3d\).htm), [GEOTYP(2D)](/docs/sk/keyword_documentation/g/geotyp/)
