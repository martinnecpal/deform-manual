...
Element(1), YLDS(1)(1), ..., YLDS(1)(4)

: :

Element(Ndata), YLDS(Ndata)(1), ..., YLDS(Ndata)(4)
...
RELATED TOPICS  
---  
Keyword: [STRESS (2D)](/docs/sk/keyword_documentation/s/stress/), [STRESS (3D)](/docs/sk/keyword_documentation/s/stress_3d/)
