...
|  (Simulation controls - 2D)  
---|---  
_Update History:_ New keyword in v12.1 |  Last updated on : 07-10-2024  
  
* * *

WINSTP Object, WinNo, WinPoint, OprStopType, CriticalValueType, VelType

{Velocity Data} (vx, vy)  
{Window Data} (Coordinates of window)  
...
WinNo |  None |  1  
WinPoint |  Points of the window |  None  
