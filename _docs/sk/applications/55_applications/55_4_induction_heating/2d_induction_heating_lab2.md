...
In Material list Window, click on ![]({{ '/assets/icons/pre_icons/mo_import_file_icon.jpg' | relative_url }}) to Load material data from DB file.
  ...
  * Navigate to the area where the FEM Induction ran ([Induction Heating Lab1](/docs/sk/applications/55_applications/55_4_induction_heating/2d_induction_heating_lab1/)) and choose the IH_Lab_2DFEM1a.DB database and select the first step.
...
In Bottom die page, click on ![]({{ '/assets/icons/pre_icons/mo_import_file_icon.jpg' | relative_url }}) and import the **Bottom Coil** object from **IH_Lab_2DFEM1a.DB** database ([Induction Heating Lab1](/docs/sk/applications/55_applications/55_4_induction_heating/2d_induction_heating_lab1/)) at **-1** step. Keep the object name to **Bottom Coil** , object type as **Rigid** and **object temperature** as **20****°C** (see Fig. 2DINDL2.17.). Click on ![]({{ '/assets/icons/pre_icons/mo_next_button.jpg' | relative_url }}) until Boundary Condition page.
