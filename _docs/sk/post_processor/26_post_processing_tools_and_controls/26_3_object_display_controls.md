---
lang: sk
title: "26.3. Object Display Controls"
---

# 26.3. Object Display Controls

26.3.1. Display Menu

26.3.2. Mouse Menu

Under Object display window we will discuss related to Display menu and Mouse menu options. 

## Display menu

Fig. 26.3.1. shows the display menu options using these options or icons in the tool bar user can select the different objects display rendering types like shading, wireframe, shading and wireframe, feature line (surface patch) and adding feature line to any other rendering types. 
...
Right mouse button measurement style options; (a) For 3D (b) For 2D
  ...
  * **Select![]({{ '/assets/icons/pre_icons/mo_select_icon.jpg' | relative_url }}) : **The select button is a general pointing utility. It performs several functions which vary with context. It can be used to select a node or an element, to select BCC, stopping controls points on objects and many similar functions. From Right mouse click option menu in graphics window user can change the selected nodes display to point or polygon as shown in Fig. 26.3.4.
