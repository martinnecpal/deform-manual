...
In Steps page, change the **Number of Steps** to **60** , **set increment to save** as **4** and Solution step definition **Time** as **1** sec/step (See [Fig. L4.19.](/docs/sk/labs/basic_labs/2d_labs/lab_03_spike_isothermal/)), then click on ![]({{ '/assets/icons/pre_icons/mo_next_button.jpg' | relative_url }}) button.
...
[35.1. 2D Heat Transfer Operation](/docs/sk/operation_templates/35_heat_transfer/35_1_2d_heat_transfer_operation/)
