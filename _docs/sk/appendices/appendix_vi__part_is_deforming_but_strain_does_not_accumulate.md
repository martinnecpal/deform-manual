...
Limiting strain rate is maintained as a fixed ratio of the “Average Strain Rate”.The ratio is defined in the preprocessor [Object Properties](/docs/sk/pre_processor/16_object_properties/16_object_properties/) and is normally 100:1. At strain rates below [LMTSTR](/docs/sk/keyword_documentation/l/lmtstr/), the flow stress is calculated based on a linear fit from 0,0 to the flow stress at [LMTSTR](/docs/sk/keyword_documentation/l/lmtstr/).
...
Strain and damage are not incremented for elements with a strain rate below [LMTSTR](/docs/sk/keyword_documentation/l/lmtstr/)
...
[LMTSTR](/docs/sk/keyword_documentation/l/lmtstr/) is maintained as a constant ratio to the average strain rate [AVGSTR](/docs/sk/keyword_documentation/a/avgstr/). After each solution step, [AVGSTR](/docs/sk/keyword_documentation/a/avgstr/) is recalculated as the non-weighted average of all deforming elements. [LMTSTR](/docs/sk/keyword_documentation/l/lmtstr/) is then recalculated based on the ratio initially defined in the preprocessor.
