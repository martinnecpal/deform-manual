...
This shows the stress assigned using the Post-processor function ([SV between two points](/docs/sk/post_processor/26_post_processing_tools_and_controls/26_6_post_processing_tools/26_6_8_state_variables_between_2_points/)) as shown in Fig. AXI.7.
...
The function is accessible in the [node data](/docs/sk/pre_processor/17_object_data_initialization/17_1_node_data_window/) dialog as shown in below Fig. AXI.8.
